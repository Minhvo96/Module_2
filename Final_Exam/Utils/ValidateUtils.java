...
public class ValidateUtils {
    ...
    private static final Pattern AGE_PATTERN = Pattern.compile("^(1[89]|[2-9][0-9])$");;

    private static final String REGEX_ID = "^[0-9]{5}$";
    ...
    public static boolean isValidStudentAge(String age) {
        return AGE_PATTERN.matcher(age).matches();
    }

    public static boolean isValidIDStudent(String id) {
